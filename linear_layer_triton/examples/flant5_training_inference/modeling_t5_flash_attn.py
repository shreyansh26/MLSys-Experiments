...
class T5Attention(nn.Module):
    ...
    def forward(
        ...
        attn_output = unshape_flash(flash_attn_func(query_states.transpose(1, 2), key_states.transpose(1, 2), value_states.transpose(1, 2), position_bias_masked, False, 1.0))
