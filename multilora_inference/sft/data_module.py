"""Dataset preparation utilities for multilora fine-tuning."""
...
def _pad_batch(tensors: Iterable[torch.Tensor], padding_value: int) -> torch.Tensor:
    return pad_sequence(list(tensors), batch_first=True, padding_value=padding_value)
