...
q = torch.randn(B, q_seq_len, nheads, headdim, dtype=torch.float16, device="cuda")
k = torch.randn(B, kv_seq_len, nheads, headdim, dtype=torch.float16, device="cuda")
v = torch.randn(B, kv_seq_len, nheads, headdim, dtype=torch.float16, device="cuda")
