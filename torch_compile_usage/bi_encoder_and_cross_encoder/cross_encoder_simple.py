...
def load_models():
    ...
    cross_encoder_2 = CrossEncoder("jina-reranker-v2-base-multilingual", device=device, trust_remote_code=True, max_length=512)
...
def main():
    ...
    np.save("outputs/simple_cross_encoder_scores_1.npy", scores1)
    np.save("outputs/simple_cross_encoder_scores_2.npy", scores2)
