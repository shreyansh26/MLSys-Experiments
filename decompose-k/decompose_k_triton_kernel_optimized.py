...
This keeps the original ``decompose_k_triton_kernel.py`` implementation intact
and adds a separate candidate optimized around the Figure 5 shape regime:
small M/N, large K, and explicit Decompose-K partials.
"""
...
from decompose_k_triton_kernel import (  # noqa: F401
    KernelConfig,
    _check_inputs,
    _partial_mm,
    decompose_k_matmul,
