...
__global__ void __launch_bounds__(NUM_THREADS) micro_optimizations(int M, int N, int K, bf16* C, const CUtensorMap* tensorMapA, const CUtensorMap* tensorMapB, float alpha, float beta, int *DB) {
