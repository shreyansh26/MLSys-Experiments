...
void async_copy_launch(cublasHandle_t handle, int M, int N, int K, float alpha, half *A, half *B, float beta, half *C, half *D) {
    constexpr unsigned int BM_dim = 256;
    constexpr unsigned int BN_dim = 128;
    constexpr unsigned int BK_dim = 64;
    ...
    cudaCheck(cudaFuncSetAttribute(async_copy<BM_dim, BN_dim, BK_dim, WM_dim, WN_dim, WK_dim, NumThreads>, cudaFuncAttributeMaxDynamicSharedMemorySize, 65536)); // set shared memory limit to 64KB which is maximum for sm_75

    async_copy<BM_dim, BN_dim, BK_dim, WM_dim, WN_dim, WK_dim, NumThreads><<<gridDim, blockDim, shmem_bytes>>>(
            A,
            B,
            C,
            D,
...
void tuning_tile_dimensions_launch(cublasHandle_t handle, int M, int N, int K, float alpha, half *A, half *B, float beta, half *C, half *D) {
    constexpr unsigned int BM_dim = 256;
    ...
    cudaCheck(cudaFuncSetAttribute(tuning_tile_dimensions<BM_dim, BN_dim, BK_dim, WM_dim, WN_dim, WK_dim, NumThreads>, cudaFuncAttributeMaxDynamicSharedMemorySize, 65536)); // set shared memory limit to 64KB which is maximum for sm_75

    tuning_tile_dimensions<BM_dim, BN_dim, BK_dim, WM_dim, WN_dim, WK_dim, NumThreads><<<gridDim, blockDim, shmem_bytes>>>(
            A,
            B,
            C,
            D,
...
void double_buffering_launch(cublasHandle_t handle, int M, int N, int K, float alpha, half *A, half *B, float beta, half *C, half *D) {
    constexpr unsigned int BM_dim = 256;
    constexpr unsigned int BN_dim = 256;
    constexpr unsigned int BK_dim = 32;
    ...
    cudaCheck(cudaFuncSetAttribute(double_buffering<BM_dim, BN_dim, BK_dim, WM_dim, WN_dim, WK_dim, NumThreads>, cudaFuncAttributeMaxDynamicSharedMemorySize, 65536)); // set shared memory limit to 64KB which is maximum for sm_75

    double_buffering<BM_dim, BN_dim, BK_dim, WM_dim, WN_dim, WK_dim, NumThreads><<<gridDim, blockDim, shmem_bytes>>>(
            A,
            B,
            C,
            D,
...
void run_kernel_fp16(int kernel_num, int M, int N, int K, float alpha, half *A, half *B, float beta, half *C, half *D, cublasHandle_t handle) {
    switch (kernel_num) {
        ...
        case 4:
            ...
            break;
        case 5:
            // std::cout << "Async Copy Kernel" << std::endl;
            async_copy_launch(handle, M, N, K, alpha, A, B, beta, C, D);
            break;
        case 6:
        ...
        case 8:
            ...
            double_buffering_launch(handle, M, N, K, alpha, A, B, beta, C, D);
            break;
        default:
