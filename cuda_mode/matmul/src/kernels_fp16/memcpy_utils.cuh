...
__device__ __forceinline__ void tileMemcpySwizzledA(half* src, half* dst, const unsigned int src_stride) {
...
// this is a special case of the above for when TILE_COLS == 32
template<unsigned int TILE_ROWS, unsigned int NUM_THREADS, unsigned int ELEMENTS_PER_THREAD>
__device__ __forceinline__ void tileMemcpySwizzledStoreA(float4 (&src_reg)[ELEMENTS_PER_THREAD], half* dst
) {
    constexpr unsigned int SWIZZLE_MASK_1 = 0b10000;
    constexpr unsigned int SWIZZLE_BITS_1 = 4;
    constexpr unsigned int SWIZZLE_MASK_2 = 0b1100;
