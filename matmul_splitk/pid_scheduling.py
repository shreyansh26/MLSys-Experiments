...
import numpy as np
from plot import create_annotated_grid
...
@triton.jit
def swizzle_k(x_ptr, z_ptr, GROUP_SIZE_M: tl.constexpr):
...
print("Swizzle-2d (same as grouped) Scheduling")
out2 = z.clone()
swizzle_k[(BLOCKS_M, BLOCKS_N)](x, out2, GROUP_SIZE_M)
